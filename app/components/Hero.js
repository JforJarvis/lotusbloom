  ...
  return (
    <div ref={ref} onMouseMove={onMove} className="hero">
      <style>{`
        ...
        /* ═══ UNIFIED DIVIDER + LOTUS ═══ */
        .divider{position:absolute;left:50%;top:0;bottom:0;width:0;z-index:18;pointer-events:none;display:flex;align-items:center;justify-content:center}
        .divider__line{position:absolute;left:-1.5px;top:0;bottom:0;width:3px;background:linear-gradient(180deg,transparent 2%,rgba(201,169,78,.15) 15%,rgba(201,169,78,.45) 42%,rgba(201,169,78,.08) 48%,rgba(201,169,78,.08) 52%,rgba(201,169,78,.45) 58%,rgba(201,169,78,.15) 85%,transparent 98%);box-shadow:0 0 8px rgba(201,169,78,.15),0 0 20px rgba(201,169,78,.06)}
        .divider__shimmer{position:absolute;left:-1.5px;width:3px;height:60px;background:linear-gradient(180deg,transparent,rgba(201,169,78,.6),transparent);animation:shimmer 5s ease-in-out infinite}
        ...
        .lotus__glow{position:absolute;inset:-24px;border-radius:50%;background:radial-gradient(circle,rgba(201,169,78,.10) 0%,rgba(201,169,78,.03) 50%,transparent 70%);filter:blur(6px);animation:breathe 4s ease-in-out .5s infinite}
      ...
      <div className="hero__grid">
        ...
        {/* DIVIDER + LOTUS — one unified element */}
        <div className="divider">
          <div className="divider__line"/>
          <div className="divider__shimmer"/>
          <div className="divider__bloom"/>
          <motion.div className="divider__lotus"
            initial={{opacity:0,scale:.85}}
            animate={{opacity:ready?1:0,scale:ready?1:.85}}
            transition={{duration:.6,delay:.2}}>
            <div className="lotus__burst"/>
